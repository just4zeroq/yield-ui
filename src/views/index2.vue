...
// 22570089
const contractAddress = '0x57e114B691Db790C35207b2e685D4A43181e6061'; // 替换为实际的合约地址
        const contractABI = [
  ...
  "function balanceOf(address addr) view returns (uint)"
       ...
       let b1= await provider.getBlockNumber()
        console.log(b1)
        const contract = new ethers.Contract(contractAddress, contractABI, provider);
        let balance = await contract.symbol()
        console.log(balance)
        let balance1 = await contract.balanceOf("0xA791D1021DdAd18C7f3c9AB6176a736564288b56")
